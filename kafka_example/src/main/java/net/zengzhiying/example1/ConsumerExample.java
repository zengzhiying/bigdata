...
public class ConsumerExample {
    ...
    public ConsumerExample(String zookeeper, String groupId) {
    ...
    public static void main(String[] args) {
        ConsumerExample cd = new ConsumerExample("zk1:2181,zk2:2181,zk3:2181/kafka",
